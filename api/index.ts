...
// 3. API Router
// We define all endpoints on apiRouter and mount it on both '/api' and '/'
// This ensures that whether Vercel preserves '/api' in the path or strips it during rewrites,
// requests like POST /api/ai/emotion-explore or POST /ai/emotion-explore will both match perfectly.
...
apiRouter.post('/ai/reflect', async (req: Request, res: Response) => {
  try {
...
apiRouter.post('/ai/emotion-explore', async (req: Request, res: Response) => {
  try {
    const body = req.body && typeof req.body === 'object' ? req.body : {};
    const { ventText } = body;
...
apiRouter.post('/ai/transform-vent', async (req: Request, res: Response) => {
  try {
    const body = req.body && typeof req.body === 'object' ? req.body : {};
...
apiRouter.post('/ai/patterns', async (req: Request, res: Response) => {
  try {
    const body = req.body && typeof req.body === 'object' ? req.body : {};
...
apiRouter.post('/ai/compare-growth', async (req: Request, res: Response) => {
  try {
    const body = req.body && typeof req.body === 'object' ? req.body : {};
...
apiRouter.post('/ai/look-back', async (req: Request, res: Response) => {
  try {
    const body = req.body && typeof req.body === 'object' ? req.body : {};
...
apiRouter.post('/ai/generate-title', async (req: Request, res: Response) => {
  try {
    const body = req.body && typeof req.body === 'object' ? req.body : {};
...
// Mount router on both '/api' and '/' so that whether the request arrives as /api/ai/emotion-explore or /ai/emotion-explore, it resolves flawlessly.
